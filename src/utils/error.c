...
static void error_print_typecheck_incompatible_matrix_vector_dimensions(error_info_t error)
{
  error_print_helper_snippet(error.incompatible_matrix_vector_dimensions.loc, "Incompatible matrix and vector dimensions.");
}
...
void error_print(error_info_t error)
{
  ...
  case ERROR_TYPECHECK_INCOMPATIBLE_MATRIX_VECTOR_DIMENSIONS: error_print_typecheck_incompatible_matrix_vector_dimensions(error); break;
...
{
  error_bag_put(bag, (error_info_t){
    .kind = ERROR_TYPECHECK_INCOMPATIBLE_MATRIX_VECTOR_DIMENSIONS,
