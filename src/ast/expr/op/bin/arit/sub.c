...
static void ast_expr_op_bin_arit_sub_typecheck_scalar(typecheck_ctx_t* ctx, ast_expr_op_bin_arit_sub_t* node, typedesc_t* lhs_desc, typedesc_t* rhs_desc)
{
...
static void ast_expr_op_bin_arit_sub_typecheck_vector(typecheck_ctx_t* ctx, ast_expr_op_bin_arit_sub_t* node, typedesc_t* lhs_desc, typedesc_t* rhs_desc)
{
...
static void ast_expr_op_bin_arit_sub_typecheck_matrix(typecheck_ctx_t* ctx, ast_expr_op_bin_arit_sub_t* node, typedesc_t* lhs_desc, typedesc_t* rhs_desc)
{
...
{
  ast_expr_op_bin_arit_sub_t* node = (ast_expr_op_bin_arit_sub_t*)malloc(sizeof(ast_expr_op_bin_arit_sub_t));
  CLEAROBJ(node);
...
void ast_expr_op_bin_arit_sub_typecheck(typecheck_ctx_t* ctx, ast_expr_op_bin_arit_sub_t* node)
{
  ...
  if (typedesc_is_arithmetic(lhs_desc))
    ast_expr_op_bin_arit_sub_typecheck_scalar(ctx, node, lhs_desc, rhs_desc);
  else if (typedesc_is_vector(lhs_desc))
    ast_expr_op_bin_arit_sub_typecheck_vector(ctx, node, lhs_desc, rhs_desc);
  else if (typedesc_is_matrix(lhs_desc))
    ast_expr_op_bin_arit_sub_typecheck_matrix(ctx, node, lhs_desc, rhs_desc);
  else
    UNREACHABLE();
}
...
void ast_expr_op_bin_arit_sub_codegen(codegen_ctx_t* ctx, ast_expr_op_bin_arit_sub_t* node)
{
  ...
  case OP_ARIT_SUB_COMPLEX: node->llvm_value = codegen_build_complex_sub(ctx, llvm_lhs_value, llvm_rhs_value); break;
  case OP_ARIT_SUB_VECTOR:  node->llvm_value = codegen_build_vector_sub(ctx, desc, llvm_lhs_value, llvm_rhs_value); break;
  case OP_ARIT_SUB_MATRIX:  node->llvm_value = codegen_build_matrix_sub(ctx, desc, llvm_lhs_value, llvm_rhs_value); break;
  default: UNREACHABLE();
  }
}
