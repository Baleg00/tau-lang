...
tau_ast_expr_op_bin_cmp_gt_t* tau_ast_expr_op_bin_cmp_gt_init(void)
{
  tau_ast_expr_op_bin_cmp_gt_t* node = (tau_ast_expr_op_bin_cmp_gt_t*)malloc(sizeof(tau_ast_expr_op_bin_cmp_gt_t));
  TAU_CLEAROBJ(node);
...
void tau_ast_expr_op_bin_cmp_gt_nameres(tau_nameres_ctx_t* ctx, tau_ast_expr_op_bin_cmp_gt_t* node)
{
  tau_ast_node_nameres(ctx, node->lhs);
  tau_ast_node_nameres(ctx, node->rhs);
}

void tau_ast_expr_op_bin_cmp_gt_typecheck(tau_typecheck_ctx_t* ctx, tau_ast_expr_op_bin_cmp_gt_t* node)
{
...
void tau_ast_expr_op_bin_cmp_gt_codegen(tau_codegen_ctx_t* ctx, tau_ast_expr_op_bin_cmp_gt_t* node)
{
