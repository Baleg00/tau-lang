...
tau_ast_expr_op_bin_bit_xor_t* tau_ast_expr_op_bin_bit_xor_init(void)
{
  tau_ast_expr_op_bin_bit_xor_t* node = (tau_ast_expr_op_bin_bit_xor_t*)malloc(sizeof(tau_ast_expr_op_bin_bit_xor_t));
  TAU_CLEAROBJ(node);
...
void tau_ast_expr_op_bin_bit_xor_nameres(tau_nameres_ctx_t* ctx, tau_ast_expr_op_bin_bit_xor_t* node)
{
  tau_ast_node_nameres(ctx, node->lhs);
  tau_ast_node_nameres(ctx, node->rhs);
}

void tau_ast_expr_op_bin_bit_xor_typecheck(tau_typecheck_ctx_t* ctx, tau_ast_expr_op_bin_bit_xor_t* node)
{
...
void tau_ast_expr_op_bin_bit_xor_codegen(tau_codegen_ctx_t* ctx, tau_ast_expr_op_bin_bit_xor_t* node)
{
