...
tau_ast_expr_op_bin_assign_bit_rsh_t* tau_ast_expr_op_bin_assign_bit_rsh_init(void)
{
  tau_ast_expr_op_bin_assign_bit_rsh_t* node = (tau_ast_expr_op_bin_assign_bit_rsh_t*)malloc(sizeof(tau_ast_expr_op_bin_assign_bit_rsh_t));
  TAU_CLEAROBJ(node);
...
void tau_ast_expr_op_bin_assign_bit_rsh_nameres(tau_nameres_ctx_t* ctx, tau_ast_expr_op_bin_assign_bit_rsh_t* node)
{
  tau_ast_node_nameres(ctx, node->lhs);
  tau_ast_node_nameres(ctx, node->rhs);
}

void tau_ast_expr_op_bin_assign_bit_rsh_typecheck(tau_typecheck_ctx_t* ctx, tau_ast_expr_op_bin_assign_bit_rsh_t* node)
{
...
void tau_ast_expr_op_bin_assign_bit_rsh_codegen(tau_codegen_ctx_t* ctx, tau_ast_expr_op_bin_assign_bit_rsh_t* node)
{
