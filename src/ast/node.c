...
void ast_node_free(ast_node_t* node)
{
  ...
  case AST_EXPR_OP_SPEC:       ast_expr_op_spec_free      ((ast_expr_op_spec_t*      )node); break;
...
void ast_node_nameres(nameres_ctx_t* ctx, ast_node_t* node)
{
  ...
  case AST_EXPR_OP_SPEC:       ast_expr_op_spec_nameres      (ctx, (ast_expr_op_spec_t*      )node); break;
...
void ast_node_typecheck(typecheck_ctx_t* ctx, ast_node_t* node)
{
  ...
  case AST_EXPR_OP_SPEC:       ast_expr_op_spec_typecheck      (ctx, (ast_expr_op_spec_t*      )node); break;
...
void ast_node_codegen(codegen_ctx_t* ctx, ast_node_t* node)
{
  ...
  case AST_EXPR_OP_SPEC:       ast_expr_op_spec_codegen      (ctx, (ast_expr_op_spec_t*      )node); break;
...
void ast_node_dump_json(FILE* stream, ast_node_t* node)
{
  ...
  case AST_EXPR_OP_SPEC:       ast_expr_op_spec_dump_json      (stream, (ast_expr_op_spec_t*      )node); break;
...
const char* ast_kind_to_cstr(ast_kind_t kind)
{
  ...
  case AST_EXPR_OP_SPEC:       return "AST_EXPR_OP_SPEC";
