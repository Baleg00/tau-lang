...
/**
 * \brief Visits and analyzes a call to function expression.
 *
 * \param[in] analyzer Pointer to the semantic analyzer.
 * \param[in] scope Pointer to the current symbol table scope.
 * \param[in] node Pointer to the call to function expression node.
 */
 ...
 * \param[in,out] typebuilder Pointer to the type builder to be used.
