 ...
 */
typedef struct tau_ast_type_type_t
{
  TAU_AST_TYPE_HEADER;
} tau_ast_type_type_t;
 ...
 */
void tau_ast_type_type_nameres(tau_nameres_ctx_t* ctx, tau_ast_type_type_t* node);
 ...
 */
void tau_ast_type_type_typecheck(tau_typecheck_ctx_t* ctx, tau_ast_type_type_t* node);
 ...
 * \param[in] node Pointer to the AST node to be visited.
 */
void tau_ast_type_type_codegen(tau_codegen_ctx_t* ctx, tau_ast_type_type_t* node);
