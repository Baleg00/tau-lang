 ...
 * \file
 * 
 * \brief Abstract syntax tree binary arithmetic multiplication assignment
 * operation expression node interface.
 * 
 * \copyright Copyright (c) 2023 Róna Balázs. All rights reserved.
 * \license This project is released under the Apache 2.0 license.
 */

#ifndef TAU_AST_EXPR_OP_BIN_ASSIGN_ARIT_MUL_H
#define TAU_AST_EXPR_OP_BIN_ASSIGN_ARIT_MUL_H
...
/**
 * \brief AST binary arithmetic multiplication assignment operation expression node.
 */
typedef struct tau_ast_expr_op_bin_assign_arit_mul_t
{
  TAU_AST_EXPR_OP_BIN_HEADER;
} tau_ast_expr_op_bin_assign_arit_mul_t;

/**
 * \brief Initializes a new AST binary arithmetic multiplication assignment
