...
/**
 * \brief Performs type check pass on an AST generic parameter declaration node.
 * 
...
/**
 * \brief Performs code generation pass on an AST generic parameter declaration node.
 * 
