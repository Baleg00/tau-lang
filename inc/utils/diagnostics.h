 ...
 */
TAU_NORETURN void tau_report_error_unexpected_character(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_identifier_too_long(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_missing_terminating_single_quote(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_missing_terminating_double_quotes(tau_location_t loc);
 ...
 * \param[in] loc Location of the character literal.
 */
TAU_NORETURN void tau_report_error_empty_character_literal(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_missing_hex_digits_in_escape_sequence(tau_location_t loc);
 ...
 * \param[in] loc Location of the escape sequence.
 */
TAU_NORETURN void tau_report_error_too_many_hex_digits_in_escape_sequence(tau_location_t loc);
 ...
 * \param[in] loc Location of the escape sequence.
 */
TAU_NORETURN void tau_report_error_unknown_escape_sequence(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_ill_formed_integer_literal(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_invalid_integer_suffix(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_ill_formed_floating_point_literal(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_unexpected_token(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_failed_to_open_file(const char* path);
 ...
 */
TAU_NORETURN void tau_report_error_non_default_after_default_parameter(tau_ast_decl_param_t* param_node, tau_ast_decl_param_t* first_default_node);
 ...
 */
TAU_NORETURN void tau_report_error_parameter_redefinition(tau_ast_decl_param_t* param_node, tau_ast_decl_param_t* redef_node);
 ...
 */
TAU_NORETURN void tau_report_error_generic_parameter_redefinition(tau_ast_decl_generic_param_t* param_node, tau_ast_decl_generic_param_t* redef_node);
 ...
 */
TAU_NORETURN void tau_report_error_variable_redefinition(tau_ast_decl_var_t* var_node, tau_ast_decl_var_t* redef_node);
 ...
 */
TAU_NORETURN void tau_report_error_struct_redefinition(tau_ast_decl_struct_t* struct_node, tau_ast_decl_t* redef_node);
 ...
 * \param[in] redef_node Pointer to the redefining AST declaration node.
 */
TAU_NORETURN void tau_report_error_union_redefinition(tau_ast_decl_union_t* union_node, tau_ast_decl_t* redef_node);
 ...
 * \param[in] redef_node Pointer to the redefining AST declaration node.
 */
TAU_NORETURN void tau_report_error_enum_redefinition(tau_ast_decl_enum_t* enum_node, tau_ast_decl_t* redef_node);
 ...
 * \param[in] redef_node Pointer to the redefining AST declaration node.
 */
TAU_NORETURN void tau_report_error_type_redefinition(tau_ast_decl_t* node, tau_ast_decl_t* redef_node);
 ...
 */
TAU_NORETURN void tau_report_error_enum_constant_redefinition(tau_ast_decl_enum_constant_t* enum_node, tau_ast_decl_enum_constant_t* redef_node);
 ...
 */
TAU_NORETURN void tau_report_error_symbol_redeclaration(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_undefined_symbol(tau_location_t loc);
 ...
 * \param[in] loc Location of the symbol.
 */
TAU_NORETURN void tau_report_error_symbol_is_not_an_expression(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_undefined_typename(tau_location_t loc);
 ...
 * \param[in] loc Location of the symbol.
 */
TAU_NORETURN void tau_report_error_symbol_is_not_a_typename(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_expected_reference_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_expected_arithmetic_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_expected_bool_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_expected_pointer_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_expected_optional_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_expected_mutable_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_expected_integer_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_incompatible_return_type(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_too_many_arguments(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_too_few_arguments(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_no_member_with_name(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_private_member(tau_location_t loc);
 ...
 */
TAU_NORETURN void tau_report_error_type_mismatch(tau_location_t loc, tau_typedesc_t* expected, tau_typedesc_t* actual);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_missing_closing_parenthesis(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_missing_closing_bracket(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_missing_unary_argument(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_missing_binary_argument(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_missing_callee(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_unknown_callconv(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_break_outside_loop(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_continue_outside_loop(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_return_outside_function(tau_location_t loc);
 ...
 * \param[in] loc Location where the error occurred.
 */
TAU_NORETURN void tau_report_error_return_inside_defer(tau_location_t loc);
